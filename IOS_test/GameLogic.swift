...
class GameLogic {
    ...
    let difficulty: Int
    let namePathFront = ["pogba", "cr", "grizi", "rash", "messi", "ibra", "pique", "ramos", "bape", "rak", "ney", "aguero", "gea", "de", "salah","haz", "kante", "linde", "lewa", "vini" ,
    ...
    func tryMatch(card: Card){
        ...
        if isMatchReady == true && card.state == Card.CardState.destapada && cardSelected?.state == Card.CardState.destapada && card.state != Card.CardState.match {
